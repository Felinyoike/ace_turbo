  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden border-b border-slate-200 bg-[#f8fafc]">
        ...
        <div className="absolute -left-24 top-16 h-72 w-72 rounded-full bg-[#0868a8]/8 blur-3xl" aria-hidden="true" />
        <div className="relative mx-auto max-w-[1200px] px-4 py-20 md:px-12">
          <p className="font-tech text-[13px] uppercase tracking-[0.3em] text-[#0868a8]">
            Business Opportunity
          </p>
          <h1 className="mt-3 font-display text-[clamp(2.5rem,6vw,5rem)] font-extrabold uppercase leading-none tracking-[-0.03em] text-[#0f172a]">
            Franchise <br /><span className="text-[#0868a8]">Opportunities</span>
          </h1>
          <p className="mt-5 max-w-2xl text-[18px] leading-8 text-[#475569]">
      ...
      <section className="border-b border-slate-200 bg-[#f8fafc]">
        <div className="mx-auto grid max-w-[1200px] grid-cols-2 divide-x divide-slate-200 px-4 md:grid-cols-4 md:px-12">
          {stats.map((s) => (
            <div key={s.label} className="px-6 py-8 text-center">
              <div className="font-display text-[2.2rem] font-extrabold text-[#0868a8]">{s.value}</div>
              <div className="mt-1 font-tech text-[10px] uppercase tracking-[0.2em] text-[#64748b]">{s.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <div className="mx-auto max-w-[1200px] px-4 py-16 md:px-12">
        <div className="grid gap-12 lg:grid-cols-[1fr_360px]">
          ...
          <div className="space-y-14">
            ...
            {/* The Opportunity */}
            <section>
              <h2 className="mb-2 font-tech text-[13px] uppercase tracking-[0.26em] text-[#0868a8]">
                Grab a Slice of the Action
              </h2>
              <h3 className="mb-5 font-display text-[2rem] uppercase text-[#0f172a]">
              ...
              <div className="space-y-5 text-[16px] leading-8 text-[#475569]">
                ...
                <p>
                  The worldwide turbo market is set to reach a record <strong className="text-[#0f172a]">$15 billion</strong> in value.
                  ...
                  remanufacture a turbo is typically <strong className="text-[#0f172a]">30% of the cost of a new turbo</strong>,
                ...
                <p>
                  There are currently over <strong className="text-[#0f172a]">12 million diesel cars</strong> registered in
            ...
            <section>
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                {[
                  ...
                  <div key={item.label} className="flex gap-4 border border-slate-200 bg-white p-5 hover:shadow-sm transition-shadow">
                    <span className="text-2xl">{item.icon}</span>
                    <div>
                      <h4 className="font-tech text-[12px] uppercase tracking-[0.18em] text-[#0f172a]">{item.label}</h4>
                      <p className="mt-1 text-[13px] leading-6 text-[#64748b]" dangerouslySetInnerHTML={{ __html: item.desc }} />
                    </div>
                  </div>
                ))}
              </div>
            ...
            <section>
              ...
              <div className="mb-6 space-y-4 text-[16px] leading-8 text-[#475569]">
                <p>
                ...
                <p>
                  ...
                  <strong className="text-[#0f172a]">not required</strong>. Anyone from an office
              ...
              <ul className="space-y-3">
                {idealTraits.map((trait) => (
                  <li key={trait} className="flex items-start gap-3 text-[15px] leading-7 text-[#475569]">
            ...
            <section>
              ...
              <div className="mb-8 space-y-5 text-[16px] leading-8 text-[#475569]">
                <p>
                  The total investment typically ranges between{" "}
                  <strong className="text-[#0f172a]">£50,000 and £65,000</strong>, of which{" "}
                  <strong className="text-[#0f172a]">£10,000 should be in liquid funds</strong>. The
                  exact figure varies depending on your chosen site, building costs and the franchise
                  package agreed.
                </p>
                <p>
                  The initial agreement is for <strong className="text-[#0f172a]">10 years</strong>,
                  and is renewable by the franchisee subject to lease and other considerations.
                </p>
              </div>

              {/* Franchise Fee callout */}
              <div className="mb-8 border border-[#0868a8]/30 bg-[#eff6ff] p-6">
                <p className="mb-2 font-tech text-[11px] uppercase tracking-[0.24em] text-[#0868a8]">
                  No Franchise Fee
                </p>
                <p className="text-[15px] leading-7 text-[#475569]">
                  Currently there is <strong className="text-[#0f172a]">no franchise fee</strong>.
              ...
              {/* Package items */}
              <h4 className="mb-5 font-display text-[1.4rem] uppercase text-[#0f172a]">
                The Franchise <span className="text-[#0868a8]">Package</span>
              </h4>
              <div className="space-y-3">
                {packageItems.map((item, i) => (
                  <div key={i} className="flex gap-4 border border-slate-200 bg-white px-5 py-4 hover:shadow-sm transition-shadow">
                    <span className="flex-shrink-0 font-tech text-[11px] text-[#0868a8]">
                      {String(i + 1).padStart(2, "0")}
                    </span>
                    <p className="text-[14px] leading-6 text-[#475569]">{item}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            {/* CTA Section */}
            <section className="relative overflow-hidden border border-slate-200 bg-[#f8fafc] p-10">
              <div className="absolute -right-8 -top-8 h-40 w-40 rounded-full bg-[#0868a8]/8 blur-3xl" aria-hidden="true" />
              <h3 className="mb-2 font-display text-[2rem] uppercase text-[#0f172a]">
                What Do I Do <span className="text-[#0868a8]">Next?</span>
              </h3>
          ...
          <aside className="space-y-6 lg:sticky lg:top-24 lg:self-start">
            <div className="border border-[#0868a8]/30 bg-[#eff6ff] p-6">
              <p className="font-tech text-[10px] uppercase tracking-[0.24em] text-[#0868a8]">Investment Summary</p>
              <div className="mt-4 space-y-4">
                {[
                  ...
                  <div key={label as string} className="flex items-start justify-between gap-2 border-b border-[#bfdbfe] pb-4 last:border-0 last:pb-0">
                    <span className="text-[12px] text-[#64748b]">{label}</span>
                    <span className="text-right font-tech text-[12px] uppercase tracking-[0.1em] text-[#0f172a]">{value}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="border border-slate-200 bg-white p-6">
              ...
              <p className="mb-4 text-[13px] leading-6 text-[#475569]">
              ...
              <a
                href="mailto:contact@aceturbo.co.uk"
                className="mt-2 block w-full border border-[#bfdbfe] py-3 text-center font-tech text-[12px] uppercase tracking-[0.2em] text-[#334155] transition hover:bg-[#eff6ff]"
              >
            ...
            <div className="border border-slate-200 bg-white p-6">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item} className="flex items-center gap-2 text-[13px] text-[#475569]">
